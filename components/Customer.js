...
import { addOrder } from '../src/actions/orderAction';
import { emptyCart } from '../src/actions/cartAction';
...
class Customer extends Component {
   ...
   export default connect(mapStateToProps, {addOrder, emptyCart})(Customer);